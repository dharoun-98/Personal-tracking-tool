 ...
 * pages themselves, where it can read account status too; this is purely about
...
export const config = {
  matcher: [
     ...
     * service worker and manifest must be excluded — running this on them can
     * rewrite their scope and silently break installation.
     */
